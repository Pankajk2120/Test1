...
import pom.pages.StaticWebTableDemo;
...
public class StaticWebTable extends BaseTest {
    ...
    public void testElectricalPermit() {
        ...
        StaticWebTableDemo StaticWebTableDemo = new StaticWebTableDemo(driver, test);
        PageFactory.initElements(driver, StaticWebTableDemo);
        
        test.log(Status.INFO, "Selenium Using Java");
        StaticWebTableDemo.RedirectToWebTable();
        StaticWebTableDemo.StaticWebTableElements();
